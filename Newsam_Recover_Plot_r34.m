%------------------------------------------------------------------------------------%
% Description: Recover info and plot, case M = N*log(N), rad = 3/4, Adaptative sampling. 
% Programer: Juan Manuel Cardenas
% Date:  July 15 - 2019  / Last update: July 15 - 2019
%------------------------------------------------------------------------------------%
%--- Set up ---%
...
load('Newsam_d2to10_NlogN_r34.mat')
